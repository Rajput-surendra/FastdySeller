...
const Color primary =Color(0xffF427C0);
const Color secondary = Color(0xffFFF100);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xffF427C0);
const Color grad2Color = Color(0xffFFF100);
