...
const Color primary =Color(0xffbf2b92);
const Color secondary = Color(0xffbf2b92);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xffbf2b92);
const Color grad2Color = Color(0xffbf2b92);
