final String appName = 'Fastdy Seller';

final String packageName = 'com.fastdy.seller';

final String iosPackage = 'com.fastdy.seller';
...
final String baseUrl = 'https://fastdy.in/seller/app/v1/api/';
