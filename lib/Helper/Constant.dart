final String appName = 'KIRANU Seller';

final String packageName = 'com.kiranu.seller';

final String iosPackage = 'com.kiranu.seller';
...
final String baseUrl = 'https://developmentalphawizz.com/kiranu/seller/app/v1/api/';
